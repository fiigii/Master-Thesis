...
The only difference between function calls and method calls is that method invocations explicitly bring \verb|this| arguments, so we need to set \verb|this| as ``receivers'' in method environments.
