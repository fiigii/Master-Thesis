...
One of the most crucial contributions of AAM is that makes context sensitivity configureable. Values' contexts are only determined by $\widetilde{alloc}$ and data type of $\widetilde{Address}$. %cite
