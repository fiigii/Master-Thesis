...
This figure indicate that \textit{h}-CFA has no any mismatch on all the programs (mismatching return percentages are 0\%), and P4F does not benefit to monovariant analysis due to its precision always same with 0-CFA-like analysis.
