...
\begin{tikzpicture}
\begin{axis}[
	symbolic x coords={mj09,eta,kcfa2,kcfa3,blur,loop2,sat,ack,cpstak,tak},
  xtick=data,
	ylabel=States,
	enlargelimits=0.05,
