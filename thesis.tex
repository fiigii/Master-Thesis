...
\Abstract{
  ...
  introduces store-allocated continuations that make the soundness of abstract interpreters easily obtainable.
  ...
  However, AAC incurs high overhead and is hard to understand, while P4F cannot compute monovariant analysis. \pagebreak
