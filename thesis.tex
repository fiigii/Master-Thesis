...
To this end, control flow analysis %TODO: cite
...
Particularly, programs written in high-order (functional) languages are hard to statically detect precise target of a function call.
To illustrate, there is a small example in Scheme. %TODO: cite
...
XXX invented \textit{k}-CFA %TODO: cite
as the first popular solution to the control flow problem.
\textit{k}-CFA applies an abstract interpretation approach to simulate programs running statically, and provides conservative over-approximations with configurable hierarchy of precision.
...
which is proved by XXX %TODO: cite
\[
O(
