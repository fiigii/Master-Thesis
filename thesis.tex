...
\textit{k}-CFA's abstraction merges the information of call stacks containing more than $k$ frames.
However, this abstraction violates the basic semantics of programming languages, where many constructs (i.e.\ function invocation, exception handling, and first-class continuation, etc.) generate \emph{recursive} control flows.
Since finite-state automata cannot accept recursive structures, pushdown system is a better choice for implementing CFAs.
